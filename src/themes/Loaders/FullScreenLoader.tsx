  ...
  return (
    <StyledWrapper>
      <svg className="pl" width="128px" height="128px" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
        <circle className="pl__ring2" cx={64} cy={64} r="52.5" fill="none" stroke="hsl(55,90%,55%)" strokeWidth={12} transform="rotate(-90,64,64)" strokeLinecap="round" strokeDasharray="329.9 329.9" strokeDashoffset="-329.3" />
